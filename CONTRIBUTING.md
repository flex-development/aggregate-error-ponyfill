...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/aggregate-error-ponyfill
   cd aggregate-error-ponyfill
   ```
...
- `release: @flex-development/aggregate-error-ponyfill@1.0.0 #13`
...
[17]: https://github.com/flex-development/aggregate-error-ponyfill/discussions/new?category=q-a
